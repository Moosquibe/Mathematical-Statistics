...
| --- | --- | --- | --- | --- | --- |
| `Lecture 1`    | 1/23 | Probability Spaces, Distributions (Review) | (https://github.com/Moosquibe/Mathematical-Statistics/blob/master/Notebooks/python_fundamentals.ipynb "Python fundamentals"), Numpy_Basics, Pandas_Basics | W 1-5, CB 1-4 | HW 1 Assigned, CHW1 Assigned | 
